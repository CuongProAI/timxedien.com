...
const FLEET = [
  ...
  },
  {
    ...
    segment: "7cho",
    segmentLabel: "MPV 7 chỗ cao cấp",
    seats: 7,
    range: "450 km/sạc",
    priceDay: 1200000,
    priceMonth: 15000000,
    overKm: 4500,
    img: "images/cars/mpv7.png",
    grad: ["#1f2937", "#0b0f14"],
    tag: "MỚI",
    desc: "MPV điện 7 chỗ thế hệ mới, phát triển trên nền tảng Limo Green nhưng nâng cấp toàn diện ngoại thất, nội thất và công nghệ. Sạc nhanh DC 80kW, đầy 10-70% chỉ 30 phút.",
    features: ["Nâng cấp toàn diện từ nền tảng Limo Green", "Sạc nhanh DC 80kW — 10-70% chỉ 30 phút", "Màn hình 10,1 inch, Apple CarPlay/Android Auto"]
  },
  {
    id: "ecvan",
    name: "VinFast EC Van",
